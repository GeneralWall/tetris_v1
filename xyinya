...
int main()
{
    ...
    while (1) {
        ...
        if (!objectgrip) {
            ...
            if (objectnumber == 0) {
                if (dir == STATIC && map[cubeypos + 1][cubexpos] == 0 && map[cubeypos + 1][cubexpos + 1] == 0) {
                ...
                else if (dir == RIGHT && map[cubeypos][cubexpos + 2] == 0 && map[cubeypos - 1][cubexpos + 2] == 0) {
                ...
                else if (dir == LEFT && map[cubeypos][cubexpos - 1] == 0 && map[cubeypos - 1][cubexpos - 1] == 0) {
